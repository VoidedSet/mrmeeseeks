...
from subsystems.tool_calling.schema_registry import TOOL_SCHEMAS, VISIBLE_TOOL_SCHEMAS, validate_tool_call, get_openai_tools
from subsystems.tool_calling.ipc_bus import bus
from subsystems.brain.state_machine import StateMachine, State
...
def build_unified_prompt(context: dict = None) -> str:
    ...
    """
    from subsystems.tool_calling.schema_registry import EXCLUDED_TOOLS
...
def build_system_prompt(context: dict = None) -> str:
    from subsystems.tool_calling.schema_registry import EXCLUDED_TOOLS, VISIBLE_TOOL_SCHEMAS
    available = [t for t in bus.registered_tools() if t not in EXCLUDED_TOOLS]
...
async def build_context(memory_agent, kernel_events: list, user_prompt: str = "") -> dict:
    ...
    """
    from subsystems.sentinel.kernel_state import state as kstate
